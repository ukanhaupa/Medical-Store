...
def open_win(): #OPENS MAIN MENU----------------------------------------------------------------------------MAIN MENU
    ...
    Button(apt,text='New Customer', width=25, command=val_cus, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),
                        bg='orange').grid(row=4,column=0)
    Button(apt,text='Add product to Stock', width=25,command=stock, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),
                        bg='orange').grid(row=5,column=0)
    Button(apt,text='Delete product from Stock', width=25,command=delete_stock, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),
                        bg='orange').grid(row=6,column=0)
    

    Label(apt, text="Access Database").grid(row=2,column=1)
    Button(apt,text='Modify',width=15, command=modify, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),
                        bg='orange').grid(row=4,column=1)
    Button(apt,text='Search', width=15, command=search, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),
                        bg='orange').grid(row=5,column=1)
    Button(apt,text='Expiry Check', width=15, command=exp_date, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=6,column=1)

    Label(apt, text="Handle Cash Flows").grid(row=2,column=2)
    Button(apt,text="Check Today's Revenue", width=20,command=show_rev, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5,column=2)
    Button(apt,text='Billing', width=20, command=billing, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=4,column=2)

    Label(apt, text='-'*80).grid(row=12,column=0,columnspan=3)    
    Button(apt,text='Logout',command=again, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='red').grid(row=13, column=2)
    apt.mainloop()
...
def delete_stock(): #OPENS DELETE WINDOW----------------------------------------------------DELETES A PARTICULAR STOCK ITEM
    ...
    ren()
    b=Button(d,width=20,text='Delete',command=delt, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=0,column=3)
    b=Button(d,width=20,text='Main Menu',command=main_menu, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5,column=3) 
    d.mainloop()
...
def modify():    # window for modification-----------------------------------------------------------------------MODIFY
    ...
    Button(st,width=10,text='Submit', command=save_mod, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=2, column=4)
    Button(st,width=10,text='Reset', command=res, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=2, column=5)
    Button(st,width=10,text='Show data', command=show_val, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=1, column=4)
    Label(st, text='-'*120).grid(row=3,column=0,columnspan=6)
    Button(st,width=10,text='Main Menu',command=main_menu, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5,column=5)
    st.mainloop()
...
def res():
    ...
    up=Entry(st)
    up.grid(row=2, column=2)
    Label(st,width=20, text='                         ').grid(row=5,column=1)
...
def save_mod(): #save modified data
    ...
    for i in range(9):
        if att.get()==col_n[i]:
            a=col[i]
    sql="update med set '%s' = '%s' where sl_no = '%s'" % (a,up.get(),st)
    cur.execute(sql)
    c.commit()
...
def stock():    #add to stock window------------------------------------------------------------------------ADD TO STOCK
    ...
    Button(sto,width=15,text='Submit',command=submit, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=12,column=1)
    Label(sto,text='-'*165).grid(row=13,column=0,columnspan=7)
    Button(sto,width=15,text='Reset',command=reset, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=12,column=0)
    Button(sto,width=15,text='Refresh stock',command=ref, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=12,column=4)
    for i in range(1,6):
        Label(sto,text=columns[i]).grid(row=14,column=i-1)
    Label(sto,text='Exp           Rack   Manufacturer                      ').grid(row=14,column=5)
    Button(sto,width=10,text='Main Menu',command=main_menu, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=12,column=5)
    ref()
    sto.mainloop()
...
def exp_date(): # expiry window open-----------------------------------------------------------------------------EXPIRY
    ...
    Button(exp,text='Check Expiry date', command=s_exp, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=3, column=1)
    Label(exp,text='-'*80).grid(row=4, column=0,columnspan=3)
    if flags=='apt1':
        Button(exp,text='Main Menu', command=main_cus, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5, column=2)
    else:
        Button(exp,width=20,text='Check Products expiring', command=exp_dt, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5, column=0)
        Button(exp,text='Main Menu', command=main_menu, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5, column=2)
    exp.mainloop()
...
def billing(): # to create bills for customer-------------------------------------------------------------BILLING system
    ...
    Button(st,text='Check V.C.', command=blue, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=4, column=0)
    ...
    Button(st,text='Add to bill',width=15,command=append2bill, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=8, column=6)
    Label(st,text='QUANTITY',width=20,relief='ridge').grid(row=7, column=5)
    qtys=Entry(st)
    qtys.grid(row=8,column=5)
    refresh()
    Button(st,width=15,text='Main Menu', command=main_menu, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=1,column=6)
    Button(st,width=15,text='Refresh Stock', command=refresh, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=3,column=6)
    Button(st,width=15,text='Reset Bill', command=billing, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=4,column=6)
    Button(st,width=15,text='Print Bill', command=print_bill, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5,column=6)
    Button(st,width=15,text='Save Bill', command=make_bill, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=7,column=6)
...
def show_rev(): # opens revenue window-----------------------------------------------------------------------TOTAL REVENUE
    ...
    c.commit()
    Button(rev,text='Main Menu',command=main_menu, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=15,column=0)
    rev.mainloop()
...
def search():   #search window medicine and symptom details---------------------------------SEARCH MEDICINE RACK & SYMPTOMS
    ...
    Button(st,width=15, text='Search', command=search_med, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=3, column=2)
    Label(st, text='-'*70).grid(row=4, column=0,columnspan=3)
    if flags=='apt1':
        Button(st,width=15, text='Main Menu', command=main_cus, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=6, column=2)
    else:
        Button(st,width=15, text='Main Menu', command=main_menu, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=6, column=2)
    st.mainloop()
...
def search_med():
    ...
    Button(top,text='OK',command=top.destroy, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5, column=0)
    c.commit()
    top.mainloop()
...
def val_cus():  #to enter new valued customer-----------------------------------------------------------NEW VALUED CUSTOMER
    ...
    Button(val,text='Submit',command=val_get, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5, column=1)
    Button(val,text='Main Menu',command=main_menu, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5, column=2)
...
def again():    #for login window-----------------------------------------------------------------------------LOGIN WINDOW
    ...
    root.title('Stark Software Solution')
    Label(root,text='Chemist and Drug Shop').grid(row=0,column=0,columnspan=5)
    Label(root,text="Shri Ram Hospital").grid(row=1,column=0,columnspan=5)
    ...
    Button(root,width=6,text='Enter',command=check, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5, column=0)
    Button(root,width=6,text='Close',command=root.destroy, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=5, column=1)
    root.mainloop()
...
def open_cus(): #OPENS MAIN MENU----------------------------------------------------------------------------MAIN MENU
    ...
    apt.title("Homepage")
    #apt.geometry("1350x750+0+0")
    Label(apt, text="Shri Ram Hospital").grid(row=0,column=0)
    ...
    Button(apt,text='Search', width=15, command=search, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=6,column=0)
    Button(apt,text='Expiry Check', width=15, command=exp_date, padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='orange').grid(row=7,column=0)
    
    Label(apt, text='-'*40).grid(row=8,column=0)    
    Button(apt,text='Logout',command=again1,padx=16,pady=1,bd=2,fg='black',font=('arial',10,'bold'),  bg='red').grid(row=9, column=0)
    apt.mainloop()
def again1():
    global flags
    apt.destroy()
